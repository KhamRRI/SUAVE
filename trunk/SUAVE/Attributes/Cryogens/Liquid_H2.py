...
class Liquid_H2(Cryogen):
    ...
    def __defaults__(self):
        ...
        self.vaporization_enthalpy      = 461.0       # [kJ/kg]
        self.specific_heat              = 10.67       # [kJ/kgK]

        # Coefficients for polynomial fit of Liquid Specific Heat Capacity (C_P) curve.
        ...
        # Coefficients for polynomial fit of Gas Specific Heat Capacity (C_P) curve.
        # C_P = CP_C3*T^3 + CP_C2*T^2 + CP_C1*T^1 + CP_C0*T^0 where C_P is Specific Heat Capacity (J/gK) T is
        # temperature (kelvin).
        ...
        # Antoine Equation Coefficients for calculating the evaporation temperature.
        ...
        # Coefficients for polynomial fit of vapourisation enthalpy
